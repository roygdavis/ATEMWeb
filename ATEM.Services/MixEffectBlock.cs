...
namespace ATEM.Services
{
    ...
    /// </summary>
    [DataContract]
    public class MixEffectBlock : IBMDSwitcherMixEffectBlockCallback, IDisposable, IMixEffectBlock
    {
        /// <summary>
        ...
        public MixEffectBlock(IBMDSwitcherMixEffectBlock meBlock, int meBlockIndex)
        {
